...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <h2 class="text-base font-semibold text-gray-800 mb-5">Edit — {{ $host->name }}</h2>
        ...
        <form method="POST" action="{{ route('hosts.update', $host) }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $host->name) }}" required
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $host->email) }}" required
                           class="w-full px-3 py-2 text-sm border rounded-lg outline-none transition
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $host->phone) }}"
                ...
                <div>
                    ...
                    <input type="text" name="department" value="{{ old('department', $host->department) }}" required
                           class="w-full px-3 py-2 text-sm border rounded-lg outline-none transition
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', $host->position) }}"
                           class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"/>
                </div>
                ...
                <div class="sm:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_active" value="1"
                               {{ old('is_active', $host->is_active ? '1' : '0') === '1' ? 'checked' : '' }}
